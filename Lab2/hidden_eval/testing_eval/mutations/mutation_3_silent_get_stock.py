...
class InventoryService:
    """MUTANT 3: Silent Missing SKU Bug (get_stock returns 999 instead of actual or error)."""
    @staticmethod
    ...
    async def get_stock(session: AsyncSession, sku: str) -> int:
        ...
        # DEFECT MUTATION: Always returns 999 for non-existent SKUs without raising exception or returning 0
        if not item:
            return 999
        return item.stock
